...
3. As a Clinic Administrator, I want to manage patient profiles so that I can keep track of their information and medical history.
...
11. As a Clinic Administrator, I want to transfer questionnaire data to our internal medical record system so that it can be stored and accessed by the clinic.`;
